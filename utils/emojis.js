...
const emojisByCategory = (emojis) => {
  return emojis.reduce((accumulation, current) => {
    if (current.category in accumulation) {
      accumulation[current.category].push(current);
    } else {
      accumulation[current.category] = [current];
    }
...
const emojisCategorized = emojisByCategory(emojis);

const emojisCategories = Object.keys(emojisCategorized);

export { emojis, emojisCategorized, emojisCategories, emojisByCategory };
